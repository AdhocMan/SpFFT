...
By default, data is copied back to host memory to exchange it with MPI. If the MPI implementation supports device memory, SpFFT can be compiled with `SPFFT_GPU_DIRECT` to avoid the data transfer to host memory.
